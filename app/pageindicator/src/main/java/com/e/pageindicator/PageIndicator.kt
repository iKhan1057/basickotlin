...
open class PageIndicator @JvmOverloads constructor(
    ...
    init {
        ...
        dotSizeMap = mapOf(
            BYTE_6 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize1, 10.dp),
            BYTE_5 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize2, 9f.dp),
            BYTE_4 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize3, 8f.dp),
            BYTE_3 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize4, 6f.dp),
            BYTE_2 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize5, 4f.dp),
            BYTE_1 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize6, 3f.dp)
        )
